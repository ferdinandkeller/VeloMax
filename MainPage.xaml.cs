...
namespace VéloMax
{
    public sealed partial class MainPage : Page
    {
        ...
        private readonly List<(string Tag, Type Page)> _pages = new List<(string Tag, Type Page)>{
            ("commandes", typeof(VéloMax.Pages.Commande)),
            ("stocks", typeof(VéloMax.Pages.Stocks)),
            ("produits", typeof(VéloMax.Pages.Produits)),
            ("clients", typeof(VéloMax.Pages.Clients)),
            ("fournisseurs", typeof(VéloMax.Pages.Fournisseurs)),
            ("statistiques", typeof(VéloMax.Pages.Statistiques)),
            ("exporter", typeof(VéloMax.Pages.Exporter)),
